...
(autothemer-deftheme  orangey-bits
 ...
 ((((class color) (min-colors #xFFFFFF))) ;; GUI/24bit only
  ...
  (orangey-bits-background-0_hard     "#000000")
  (orangey-bits-background-0          "#190700")
  (orangey-bits-background-0_soft     "#200500")
  ...
  (orangey-bits-foreground-0_hard     "#FFFFFF")
  (orangey-bits-foreground-0          "#FFE0C0")
  (orangey-bits-foreground-0_soft     "#FFA030")
  ...
  (orangey-bits-neutral_red          "#FF9900")
  (orangey-bits-neutral_green        "#FF9900")
  (orangey-bits-neutral_yellow       "#FF9A03")
  (orangey-bits-neutral_blue         "#FFB240")
  (orangey-bits-neutral_purple       "#FFB240")
  (orangey-bits-neutral_teal         "#FFB050")
  (orangey-bits-neutral_orange       "#FF9900")
  (orangey-bits-neutral_cyan         "#FFCC80")

  (orangey-bits-faded_red            "#FFB259")
  (orangey-bits-faded_green          "#B97E40")
  (orangey-bits-faded_yellow         "#FFB359")
  (orangey-bits-faded_blue           "#A06537")
  (orangey-bits-faded_purple         "#FFB059")
  (orangey-bits-faded_teal           "#905132")
  (orangey-bits-faded_orange         "#BA6D41")
  (orangey-bits-faded_cyan           "#BA8141")

  (orangey-bits-muted_red            "#FFE1BF")
  (orangey-bits-muted_green          "#B9A28A")
  (orangey-bits-muted_yellow         "#FFE1BF")
  (orangey-bits-muted_blue           "#A08978")
  (orangey-bits-muted_purple         "#FFE0BF")
  (orangey-bits-muted_teal           "#90776C")
  (orangey-bits-muted_orange         "#BA9C8B")
  (orangey-bits-muted_cyan           "#BAA48B")

  (orangey-bits-background-_red       "#190F01")
  (orangey-bits-background-_green     "#261E13")
  (orangey-bits-background-_yellow    "#261701")
  (orangey-bits-background-_blue      "#261B0C")
  (orangey-bits-background-_purple    "#262019")
  (orangey-bits-background-_teal      "#261E14")
  (orangey-bits-background-_orange    "#261600")
  (orangey-bits-background-_cyan      "#26221E")

  (orangey-bits-mid_red              "#BF3000")
  (orangey-bits-mid_green            "#894F0F")
  (orangey-bits-mid_yellow           "#AF4F00")
  (orangey-bits-mid_blue             "#934F0F")
  (orangey-bits-mid_purple           "#BF4F0F")
  (orangey-bits-mid_teal             "#B04D00")
 ...
 ((default                                   (:foreground orangey-bits-foreground-0 :background orangey-bits-background-0))
  ...
  (mode-line                                 (:foreground orangey-bits-foreground-1 :background orangey-bits-background-0_hard :box nil))
  ...
  (whitespace-trailing                       (:foreground orangey-bits-neutral_red :background orangey-bits-background-1))
  (whitespace-line                           (:foreground orangey-bits-neutral_red :background orangey-bits-background-1))
  ...
  (hi-yellow                                 (:foreground orangey-bits-background-0_hard :background orangey-bits-bright_yellow))
  ...
  (org-column-title                          (:background orangey-bits-background-0_hard :underline t :weight 'bold))
  ...
  (spaceline-evil-motion                     (:background orangey-bits-bright_green :foreground orangey-bits-background-0))
  ...
  (sml/sudo                                  (:foreground orangey-bits-background-_orange :weight 'bold))
  ...
  (anzu-match-3                              (:foreground orangey-bits-background-0 :background orangey-bits-bright_cyan))
  ...
  (popup-tip-face                            (:foreground orangey-bits-foreground-0_hard :background orangey-bits-background-_teal))
  ...
  (company-template-field                    (:foreground orangey-bits-bright_blue :background nil :underline orangey-bits-background-_blue))
  ...
  (company-tooltip                           (:foreground orangey-bits-foreground-0_hard :background orangey-bits-background-1))
  ...
  (company-tooltip-annotation                (:foreground orangey-bits-bright_blue :background orangey-bits-background-1))
  (company-tooltip-common-selection          (:foreground orangey-bits-foreground-0 :background orangey-bits-faded_blue))
  ...
  (diredp-dir-priv                           (:foreground orangey-bits-faded_cyan  :background orangey-bits-background-_blue))
  (diredp-exec-priv                          (:foreground orangey-bits-faded_cyan  :background orangey-bits-background-_blue))
  (diredp-link-priv                          (:foreground orangey-bits-faded_teal  :background orangey-bits-background-_teal))
  ...
  (magit-diff-context-highlight              (:foreground orangey-bits-foreground-4 :background orangey-bits-background-0_soft))
  (magit-diff-added                          (:foreground orangey-bits-bright_green :background orangey-bits-background-_green))
  (magit-diff-added-highlight                (:foreground orangey-bits-bright_green :background orangey-bits-background-_green))
  (magit-diff-removed                        (:foreground orangey-bits-bright_red :background orangey-bits-background-_red))
  (magit-diff-removed-highlight              (:foreground orangey-bits-bright_red :background orangey-bits-background-_red))
  ...
  (magit-diff-merge-current                  (:background orangey-bits-background-_yellow))
  (magit-diff-merge-diff3-separator          (:foreground orangey-bits-neutral_orange :weight 'bold))
  (magit-diff-merge-proposed                 (:background orangey-bits-background-_green))
  ...
  (magit-log-head-label-head                 (:foreground orangey-bits-foreground-0 :background orangey-bits-background-_teal))
  ...
  (magit-section-heading                     (:foreground orangey-bits-foreground-2 :background orangey-bits-background-_blue))
  ...
  (ac-gtags-selection-face                  (:background orangey-bits-background-_cyan :inherit 'ac-selection-face))
  ...
  (ac-yasnippet-selection-face              (:background orangey-bits-background-_red :inherit 'ac-selection-face))
  ...
  (cua-global-mark                          (:foreground orangey-bits-black :background orangey-bits-foreground-0_hard))
  ...
  (custom-invalid                           (:foreground orangey-bits-foreground-0_hard :background orangey-bits-faded_red))
  ...
  (diff-refine-added                        (:background orangey-bits-background-_green :inherit 'diff-refine-change))
  (diff-refine-changed                      (:background orangey-bits-background-_blue))
  (diff-refine-removed                      (:background orangey-bits-background-_red :inherit 'diff-refine-change))
  ...
  (diredfl-dir-priv                         (:foreground orangey-bits-bright_cyan :background orangey-bits-background-1))
  (diredfl-exec-priv                        (:foreground orangey-bits-bright_orange :background orangey-bits-background-1))
  (diredfl-link-priv                        (:foreground orangey-bits-bright_purple :background orangey-bits-background-1))
  ...
  (diredfl-read-priv                        (:foreground orangey-bits-bright_teal :background orangey-bits-background-1))
  (diredfl-write-priv                       (:foreground orangey-bits-bright_green :background orangey-bits-background-1))

  (diredfl-symlink                          (:foreground orangey-bits-neutral_cyan))

  (dropdown-list-face                       (:foreground orangey-bits-black :background orangey-bits-foreground-0_hard :inherit 'default))
  ...
  (gnus-group-mail-1                        (:weight 'bold :foreground orangey-bits-foreground-0_hard))
  (gnus-group-mail-1-empty                  (:foreground orangey-bits-foreground-0_hard))
  ...
  (gnus-summary-cancelled                   (:foreground orangey-bits-foreground-0_hard :background orangey-bits-black))
  ...
  (magit-diff-base                          (:foreground orangey-bits-foreground-0_hard :background orangey-bits-background-2))
  (magit-diff-base-highlight                (:foreground orangey-bits-foreground-0_soft :background orangey-bits-background-3))
  ...
  (magit-diff-hunk-heading                  (:foreground orangey-bits-neutral_purple :background orangey-bits-background-1))
  (magit-diff-hunk-heading-highlight        (:foreground orangey-bits-neutral_purple :background orangey-bits-background-3))
  ...
  (magit-section-highlight                  (:background orangey-bits-background-0_soft))
  ...
  (semantic-highlight-edits-face            (:background orangey-bits-background-0_soft))
  (semantic-highlight-func-current-tag-face (:background orangey-bits-background-0_soft))
  ...
  (stripe-highlight                         (:background orangey-bits-background-0_hard))
  ...
  (tooltip                                  (:foreground orangey-bits-black :background orangey-bits-foreground-0_hard :inherit 'variable-pitch))
  ...
  (tty-menu-enabled-face                    (:weight 'bold :foreground orangey-bits-foreground-0_hard :background orangey-bits-mid_cyan))
 ...
 (custom-theme-set-variables 'orangey-bits
                             `(pos-tip-foreground-color ,orangey-bits-foreground-0_hard)
                             `(pos-tip-background-color ,orangey-bits-background-_teal)
