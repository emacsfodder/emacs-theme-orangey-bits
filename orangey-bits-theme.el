...
(autothemer-deftheme  orangey-bits
 ...
 ((((class color) (min-colors #xFFFFFF))) ;; GUI/24bit only
  ...
  (orangey-bits-background0          "#190700")
  (orangey-bits-background0_soft     "#200500")
  (orangey-bits-background1          "#301000")
  (orangey-bits-background2          "#401000")
  (orangey-bits-background3          "#471000")
  (orangey-bits-background4          "#4F1000")
  ...
  (orangey-bits-background_red       "#190F01")
  (orangey-bits-background_green     "#261E13")
  (orangey-bits-background_yellow    "#261701")
  (orangey-bits-background_blue      "#261B0C")
  (orangey-bits-background_purple    "#262019")
  (orangey-bits-background_teal      "#261E14")
  (orangey-bits-background_orange    "#261600")
  (orangey-bits-background_cyan      "#26221E")
 ...
 ((default                                   (:foreground orangey-bits-foreground0 :background orangey-bits-background0))
  ...
  (vertical-border                           (:foreground orangey-bits-accent-1))
  (border                                    (:background orangey-bits-accent-1))

  (window-divider                            (:foreground orangey-bits-accent-1))
  (window-divider-first-pixel                (:foreground orangey-bits-accent-1))
  (window-divider-last-pixel                 (:foreground orangey-bits-accent-1))
  ...
  (secondary-selection                       (:background orangey-bits-accent-2))
  (cua-rectangle                             (:background orangey-bits-accent-1 :distant-foreground orangey-bits-foreground0))
  (header-line                               (:foreground orangey-bits-accent-6 :background orangey-bits-background0 :bold nil))
  (minibuffer-prompt                         (:foreground orangey-bits-accent-1 :background orangey-bits-background0 :bold nil))
  ...
  (magit-diff-context                        (:foreground orangey-bits-foreground4 :background nil))
  (magit-diff-context-highlight              (:foreground orangey-bits-foreground4 :background orangey-bits-background0_soft))
  (magit-diff-added                          (:foreground orangey-bits-bright_green :background orangey-bits-background_green))
  (magit-diff-added-highlight                (:foreground orangey-bits-bright_green :background orangey-bits-background_green))
  (magit-diff-removed                        (:foreground orangey-bits-bright_red :background orangey-bits-background_red))
  (magit-diff-removed-highlight              (:foreground orangey-bits-bright_red :background orangey-bits-background_red))
  ...
  (ac-gtags-selection-face                  (:background orangey-bits-background_cyan :inherit 'ac-selection-face))
  ...
  (ac-yasnippet-selection-face              (:background orangey-bits-background_red :inherit 'ac-selection-face))
